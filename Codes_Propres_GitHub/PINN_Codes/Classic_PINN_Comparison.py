...
# for N_residuals in np.array([500]):
for N_data in np.array([10,20,40,60,80,100,150,200,250,300,400,500]):
    ...
    while(loss_value_1>tolAdam and it<=1000000):
        ...
        if it%itdisp == 0:
            ...
            count.append(it)
            print('Nd='+str(N_data)+' Adam it %d - Loss value :  %.3e' % (it, loss_value_1))
        it += 1
    N_plot = 1000
    ...
    plt.show()
    np.savetxt(r"C:\\Users\Morgan\Videos\PINN_Theory\Classic_PINN_Data_Impact_Ndata=50_Error=1e-5\Validation_Loss_2_"+str(N_data)+".txt",np.array([count,V2_Loss_list_Adam]))
    np.savetxt(r"C:\\Users\Morgan\Videos\PINN_Theory\Classic_PINN_Data_Impact_Ndata=50_Error=1e-5\Training_Loss_1_2_"+str(N_data)+".txt",np.array([count,Loss_list_Adam_1]))
    np.savetxt(r"C:\\Users\Morgan\Videos\PINN_Theory\Classic_PINN_Data_Impact_Ndata=50_Error=1e-5\Training_Loss_2_2_"+str(N_data)+".txt",np.array([count,Loss_list_Adam_2]))
    print(V2_Loss_list_Adam[-1])
...
#     count_list.append(count_array[index[i],i])


# plt.plot([1,5,10,20,40,80,150,300],val_list,color=(0.3,0.3,0.3))
# plt.ylabel("Test loss")
# plt.xlabel("Number of penalization points")
# plt.yscale('log')
# plt.legend()
# tpl.save(r"C:\Users\Morgan\Desktop\Loss_Classic_Nresiduals.tex")
# plt.show()

# plt.plot([1,5,10,20,40,80,150,300],count_list,color=(0.3,0.3,0.3))
# plt.ylabel("Number of iteration")
# plt.xlabel("Number of penalization points")
# plt.legend()
# tpl.save(r"C:\Users\Morgan\Desktop\Iteration_Classic_Nresiduals.tex")
# plt.show()
...
plt.plot([10,20,40,60,80,100,150,200,250,300,400,500],val_list,color=(0.3,0.3,0.3))
plt.yscale("log")
plt.ylabel("Test loss")
plt.xlabel("Ndata")
...
plt.plot([10,20,40,60,80,100,150,200,250,300,400,500],count_list,color=(0.3,0.3,0.3))
