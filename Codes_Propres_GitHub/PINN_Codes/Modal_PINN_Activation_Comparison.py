...
# Number of modes used in the modal PINNs
N_nn = 8
...
eigenValues,eigenVectors = result(u,alpha,beta,gamma)
...
# Frequencies used for the modal PINN
Omega_P = eigenValues
...
# Spatial modes from the output of the NN
...
for case in range(1,11):
    ...
    np.savetxt("C:\\Users\Morgan\Videos\PINN_theory\Modal_Sin_Maxiter\TXXNN_Tip_"+str(case)+".txt",np.array([t_plots,eta(L,t_plots),x_PINN]))
    np.savetxt("C:\\Users\Morgan\Videos\PINN_theory\Modal_Sin_Maxiter\Training_loss_1_"+str(case)+".txt",np.array([count,Loss_list_Adam_1]))
    np.savetxt("C:\\Users\Morgan\Videos\PINN_theory\Modal_Sin_Maxiter\Training_loss_2_"+str(case)+".txt",np.array([count,Loss_list_Adam_2]))
    np.savetxt("C:\\Users\Morgan\Videos\PINN_theory\Modal_Sin_Maxiter\Validation_Loss_"+str(case)+".txt",np.array([count,V2_Loss_list_Adam]))
...
# Loop to train 10 models and obtain average results
    ...
    t_plots = np.linspace(0,tmax,N_plot)
    x_PINN = sess.run(NN_time(tf.constant(L*np.ones(N_plot),dtype=tf.float32,shape=[N_plot,]),tf.constant(t_plots,dtype=tf.float32,shape=[N_plot,]),W,b,Omega_P)) 
    np.savetxt("C:\\Users\Morgan\Videos\PINN_theory\Modal_Tanh_Maxiter\TXXNN_Tip_"+str(case)+".txt",np.array([t_plots,eta(L,t_plots),x_PINN]))
    np.savetxt("C:\\Users\Morgan\Videos\PINN_theory\Modal_Tanh_Maxiter\Training_loss_1_"+str(case)+".txt",np.array([count,Loss_list_Adam_1]))
    np.savetxt("C:\\Users\Morgan\Videos\PINN_theory\Modal_Tanh_Maxiter\Training_loss_2_"+str(case)+".txt",np.array([count,Loss_list_Adam_2]))
    np.savetxt("C:\\Users\Morgan\Videos\PINN_theory\Modal_Tanh_Maxiter\Validation_Loss_"+str(case)+".txt",np.array([count,V2_Loss_list_Adam]))
